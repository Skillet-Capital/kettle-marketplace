...
export interface KettleVolumeTrackerInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "MINTER_ROLE"
      | "allowance"
...
export interface KettleVolumeTracker extends BaseContract {
  connect(runner?: ContractRunner | null): KettleVolumeTracker;
  waitForDeployment(): Promise<this>;

  interface: KettleVolumeTrackerInterface;
